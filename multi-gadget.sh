...
CONTROL_HEADER="$CONFIGFS_ROOT/functions/uvc.usb0/control/header/h"
ln -sf "$CONTROL_HEADER" "$CONFIGFS_ROOT/functions/uvc.usb0/control/class/fs/h" 2>/dev/null || true
